...
In the interest of relating these predictions to data from the untargeted
ASAS-SN survey~\citep{Shappee2014, Kochanek2017}, we take the full galaxy
...
$t_\text{D} = 150$ Myr and found similar results.
\par
% \par
...
we use the~\citet{Zahid2014} formalism in~\S~\ref{sec:predictions} below
